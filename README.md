...
- Video playback with synchronized map overlay is planned for the next phase.
...
- Playback and review for saved video walks.
- Route/video progress synchronization.
- iCloud sync.
- Route thumbnails.
